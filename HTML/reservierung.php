              ...
              <form class="form-check" action="/actions/change_booking_status.php" method="POST">
                ...
                <section class="row gy-3">    
                    <section class="col-md">
                        <button type="submit" value="1" id="stornieren" name="change_status" class="btn btn-danger" <?php if ($booking['status'] == "storniert")echo "hidden"; ?>>Stornieren</button>
                    </section>
                        <section class="col-md">
                        <button type="submit" value="2" class="<?php if ($booking['status'] != "storniert") ?> btn btn-success" id="bestätigen" name="change_status" <?php if ($booking['status'] == "bestätigt")
                        echo "hidden"; ?>>Bestätigen</button>
                    </section>
                    <section class="col-md">
                        <a href="reservierungen.php" class="btn btn-secondary">Zurück</a>
                    </section>
                </section>
              </form>
            </section>
