        ...
        <article id="data-splitter">
            ...
            <section class="data-splitter flex-row jstfy-center">
                <p class="width65">
                    ...
                    <br />
                    <strong>Ob Casual Gamer oder Profi – bei uns findet jeder die perfekte
            ...
            <section class="data-splitter flex-row jstfy-center">
                <p class="width75">
                    ...
                    Welt!
                    <br />
                    <img src="/Public/Images/Hotel_room_single.jpg" alt="Einzel Gamingzimmer" style="margin-top: 10px"
                        class="width100 shadow_purple" />
                    <img src="/Public/Images/Hotel_room_teams.jpg" alt="Team Gamingzimmer" style="margin-top: 10px"
                        class="width100 shadow_purple" />
                </p>
            </section>
